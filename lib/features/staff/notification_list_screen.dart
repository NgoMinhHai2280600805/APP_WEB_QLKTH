...
class StaffNotificationListScreen extends StatefulWidget {
  const StaffNotificationListScreen({super.key});

  @override
  State<StaffNotificationListScreen> createState() =>
      _StaffNotificationListScreenState();
}

class _StaffNotificationListScreenState
    extends State<StaffNotificationListScreen> {
  // Chế độ chọn nhiều
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                    ...
                    onTap: () {
                      if (_isSelectionMode) {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                StaffNotificationDetailScreen(logData: data),
                          ),
                        );
                      }
                    },
          ...
          // Nút đánh dấu chỉ hiện khi ở chế độ chọn nhiều
          if (_isSelectionMode)
            Container(
